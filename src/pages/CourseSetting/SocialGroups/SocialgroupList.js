...
import CoursetechlistInside from "./CoursetechlistInside";
import { GetAllTechnologyCall } from "../../core/Interceptor/Courses/GetAllTechnologyCall";

const CourseTechList = () => {
  ...
  const run = async () => {
    setloading(true);
    const result = await GetAllTechnologyCall(
      page,
      rowsofpage,
      sortingcol,
      SortType,
  ...
  return (
    <Row className="match-height">
      ...
      {loading ? (
        ...
        <CoursetechlistInside getcourse={getcourse} />
        // getcourse?.map((el) => (
