      ...
      <Row tag={Form} onSubmit={handleSubmit(onSubmit)}>
        <Col xs={12}>
          ...
          {errors.classRoomName && (
            <FormFeedback>لطفاً نام کلاس را وارد کنید</FormFeedback>
          )}
        </Col>
        <Col xs={12} className="mt-1">
          ...
          {errors.capacity && (
            <FormFeedback>ظرفیت کلاس الزامی است</FormFeedback>
          )}
        </Col>
        {!selected && (
          <Col xs={12} className="mt-1">
        ...
        <Col xs={12} className="text-center mt-2">
          <Button type="submit" className="me-1" color="primary">
            {selected ? "به‌روزرسانی" : "ایجاد کلاس"}
          </Button>
      ...
      >
        ...
        >
          <div className="text-center mb-2">
            <h1 className="mb-1">
              {selected ? "ویرایش دپارتمان" : "افزودن کلاس جدید"}
            </h1>
