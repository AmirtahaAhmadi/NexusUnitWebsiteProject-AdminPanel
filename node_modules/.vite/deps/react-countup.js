    ...
    !function(t, i) {
      ...
      var i = function() {
        return i = Object.assign || function(t2) {
          for (var i2, e2 = 1, s = arguments.length; e2 < s; e2++)
            for (var n in i2 = arguments[e2])
        ...
        function t2(t3, e2, s) {
          ...
          this.endVal = e2, this.options = s, this.version = "2.10.1", this.defaults = { startVal: 0, decimalPlaces: 0, duration: 2, useEasing: true, useGrouping: true, useIndianSeparators: false, smartEasingThreshold: 999, smartEasingAmount: 333, separator: ",", decimal: ".", prefix: "", suffix: "", autoAnimate: false, autoAnimateDelay: 200, autoAnimateOnce: false }, this.finalEndVal = null, this.useEasing = true, this.countDown = false, this.error = "", this.startVal = 0, this.paused = true, this.once = false, this.count = function(t4) {
            ...
            if (e3 = r[0], s2 = r.length > 1 ? n.options.decimal + r[1] : "", n.options.useGrouping) {
              a = "";
              for (var l = 3, u = 0, h = 0, p = e3.length; h < p; ++h)
                n.options.useIndianSeparators && 4 === h && (l = 2, u = 1), 0 !== h && u % l == 0 && (a = n.options.separator + a), u++, a = e3[p - h - 1] + a;
              e3 = a;
            }
        ...
        return t2.prototype.setupObserver = function() {
          ...
          if (Math.abs(i2) > this.options.smartEasingThreshold && this.options.useEasing) {
            ...
            this.endVal = t3, this.finalEndVal = null;
          ...
          if (this.el) {
            ...
            if (null === (i2 = this.options.plugin) || void 0 === i2 ? void 0 : i2.render)
              this.options.plugin.render(this.el, e2);
            else if ("INPUT" === this.el.tagName)
              this.el.value = e2;
            else
              "text" === this.el.tagName || "tspan" === this.el.tagName ? this.el.textContent = e2 : this.el.innerHTML = e2;
          }
