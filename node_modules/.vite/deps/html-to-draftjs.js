...
var require_html_to_draftjs = __commonJS({
  "node_modules/html-to-draftjs/dist/html-to-draftjs.js"(exports, module) {
    init_virtual_process_polyfill();
    init_buffer();
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t((init_immutable_es(), __toCommonJS(immutable_es_exports)), require_Draft()) : "function" == typeof define && define.amd ? define(["immutable", "draft-js"], t) : "object" == typeof exports ? exports.htmlToDraftjs = t((init_immutable_es(), __toCommonJS(immutable_es_exports)), require_Draft()) : e.htmlToDraftjs = t(e.immutable, e["draft-js"]);
    }(window, function(n, r) {
      return o = {}, i.m = a = [function(e, t) {
        ...
        var _ = function(e2) {
          ...
          if (e2 instanceof HTMLAnchorElement) {
            var n3 = {};
            t2 = e2.dataset && void 0 !== e2.dataset.mention ? (n3.url = e2.href, n3.text = e2.innerHTML, n3.value = e2.dataset.value, v.Entity.__create("MENTION", "IMMUTABLE", n3)) : (n3.url = e2.getAttribute && e2.getAttribute("href") || e2.href, n3.title = e2.innerHTML, n3.targetOption = e2.target, v.Entity.__create("LINK", "MUTABLE", n3));
          }
          return t2;
        };
        ...
        function I(e2, t2, n3, r3, i2, a2) {
          ...
          if ("br" === o2)
            return { chunk: M() };
          if ("img" === o2 && e2 instanceof HTMLImageElement) {
            var u2 = {};
          ...
          if ("video" === o2 && e2 instanceof HTMLVideoElement) {
            var d2 = {};
          ...
          if ("iframe" === o2 && e2 instanceof HTMLIFrameElement) {
            var m = {};
          ...
          y && ("ul" === o2 || "ol" === o2 ? (r3 = o2, n3 += 1) : ("unordered-list-item" !== y && "ordered-list-item" !== y && (r3 = "", n3 = -1), j ? (h = E(y, S(e2)), j = false) : h = w(y, n3, S(e2)))), h = h || k(), t2 = function(e3, t3, n4) {
            var r4, i3 = O[e3];
            if (i3)
              ...
              r4 = (r4 = n4).withMutations(function(e4) {
                ...
                t4 && e4.add("color-".concat(t4.replace(/ /g, ""))), n5 && e4.add("bgcolor-".concat(n5.replace(/ /g, ""))), r5 && e4.add("fontsize-".concat(r5.replace(/px$/g, ""))), i4 && e4.add("fontfamily-".concat(i4)), "bold" === a3 && e4.add(O.strong), "underline" === o3 && e4.add(O.ins), "italic" === l2 && e4.add(O.em);
              }).toOrderedSet();
            }
            return r4;
          }(o2, e2, t2);
        ...
        if (i.r(n2), Object.defineProperty(n2, "default", { enumerable: true, value: t }), 2 & e && "string" != typeof t)
          for (var r2 in t)
...
export default require_html_to_draftjs();
