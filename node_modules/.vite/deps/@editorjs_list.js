...
var v = class {
  ...
  renderWrapper(t) {
    let n;
    return t === true ? n = c.make("ol", [v.CSS.wrapper, v.CSS.orderedList]) : n = c.make("ol", [v.CSS.orderedList, v.CSS.itemChildren]), n;
  }
  renderItem(t, n) {
...
var b = class {
  ...
  renderWrapper(t) {
    let n;
    return t === true ? n = c.make("ul", [b.CSS.wrapper, b.CSS.unorderedList]) : n = c.make("ul", [b.CSS.unorderedList, b.CSS.itemChildren]), n;
  }
  renderItem(t, n) {
...
var f = class {
  ...
  renderWrapper(t) {
    let n;
    return t === true ? (n = c.make("ul", [f.CSS.wrapper, f.CSS.checklist]), n.addEventListener("click", (r) => {
      const i = r.target;
      if (i) {
  ...
  renderItem(t, n) {
    ...
    return n.checked === true && l.classList.add(f.CSS.itemChecked), this.readOnly && l.classList.add(f.CSS.checkboxCheckDisabled), a.innerHTML = Ct, l.appendChild(a), r.appendChild(l), r.appendChild(i), r;
  }
  getItemContent(t) {
...
var z = class {
  ...
  save(t) {
    const n = t != null ? t : this.listWrapper, r = (l) => y(l).map((o) => {
  ...
  pasteHandler(t) {
    ...
    const l = (s) => Array.from(s.querySelectorAll(":scope > li")).map((d) => {
      ...
      return {
        content: (_a = d.innerHTML) != null ? _a : "",
        meta: {},
        items: p
      };
    });
  ...
  mergeItemWithPrevious(t) {
    ...
    const d = n || i, u = (_a = C(d)) != null ? _a : this.renderer.renderWrapper(false);
    n ? o.forEach((p) => {
      u.appendChild(p);
    }) : o.forEach((p) => {
      u.prepend(p);
  ...
  renderItem(t, n) {
    const r = n != null ? n : this.renderer.composeDefaultMeta();
    switch (true) {
  ...
  renderSettings() {
    ...
    if (this.listStyle === "ordered") {
      const n = or(
        ...
        {
          value: String((_a = this.data.meta.start) != null ? _a : 1),
          placeholder: "",
          attributes: {
            required: "true"
          },
