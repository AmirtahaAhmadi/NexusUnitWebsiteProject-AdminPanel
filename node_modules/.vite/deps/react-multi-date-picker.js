  ...
  "node_modules/react-date-object/dist/index.module.js"() {
    ...
    z = function() {
      function i2(t2) {
        ...
        if (n2 && "boolean" != typeof n2 || (n2 = { date: new Date() }), D(n2) || (n2 = { date: n2 }), 0 !== Object.keys(n2).length) {
          for (var s3 in D(n2.calendar) && v(this, T, n2.calendar), D(n2.locale) && v(this, P, n2.locale), isNaN(n2.year) && isNaN(n2.month) && isNaN(n2.day) && !n2.date && (n2.date = new Date()), n2.date && ("string" == typeof n2.date && n2.format && v(this, I, n2.format), this.setDate(n2.date), n2.calendar && this.convert(n2.calendar), r2 = false), delete n2.calendar, delete n2.locale, delete n2.date, n2)
            this.set(s3, n2[s3]);
