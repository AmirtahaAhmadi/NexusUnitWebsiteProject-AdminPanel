...
var ra = class extends E {
  ...
  async update(e, t, o) {
    ...
    const i = await e.data, s = this.composeBlock({
      id: e.id,
      tool: e.name,
      data: Object.assign({}, i, t != null ? t : {}),
      tunes: o != null ? o : e.tunes
...
var Rn = class Dn extends E {
  ...
  async processDataTransfer(e, t = false) {
    ...
    const c = Object.keys(this.toolsTags).reduce((p, g) => {
      var _a2;
      return p[g.toLowerCase()] = (_a2 = this.toolsTags[g].sanitizationConfig) != null ? _a2 : {}, p;
    }, {}), d = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), h = Z(l, d);
  ...
  getPatternsConfig(e) {
    e.pasteConfig === false || !e.pasteConfig.patterns || V(e.pasteConfig.patterns) || Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
      o instanceof RegExp || S(
        `Pattern ${o} for \xAB${e.name}\xBB Tool is skipped because it should be a Regexp instance.`,
        "warn"
...
var fo = class {
  ...
  constructor({ data: e, config: t, api: o, readOnly: i }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : fo.DEFAULT_PLACEHOLDER, this._data = e != null ? e : {}, this._element = null, this._preserveBlank = (_a2 = t.preserveBlank) != null ? _a2 : false;
  }
  onKeyUp(e) {
...
var ka = class extends Tt {
  ...
  get isReadOnlySupported() {
    var _a2;
    return (_a2 = this.constructable[We.IsReadOnlySupported]) != null ? _a2 : false;
  }
};
...
var vo = class extends Tt {
  ...
  get pasteConfig() {
    var _a2;
    return (_a2 = this.constructable[pe.PasteConfig]) != null ? _a2 : {};
  }
  get sanitizeConfig() {
